...
Les espèces du Nord présentent un SPI moyen de 69% (sd = 36%).  
Les espèces du Sud présentent un SPI moyen 40% (sd = 34%).  
...
#| fig-cap: "Valeur de l'indicateur de protection des espèces en 2023, à partir des données d'occurrences (n = 503), les espèce retrouvées dans le nord."
#| warning: false
# conversion from species characters to ordered levels of factor for keeping increasing SPI
...
#| fig-cap: "Valeur de l'indicateur de protection des espèces en 2023, à partir des données d'occurrences (n = 503), les espèce retrouvées dans le sud."
#| warning: false
# conversion from species characters to ordered levels of factor for keeping increasing SPI
...
#| fig-cap: "Valeur de l'indicateur de protection des espèces en 2023, à partir des données d'occurrences (n = 503), les espèce retrouvées dans le nord et le sud simultanément."
#| warning: false
