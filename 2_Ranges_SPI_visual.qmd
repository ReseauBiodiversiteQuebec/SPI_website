...
#| fig-cap: "Valeur de l'indicateur de protection des espèces en 2023, à partir des données d'aires de répartition (n = 225)."
#| warning: false
...
#| fig-cap: "Valeur de l'indicateur de protection des espèces en 2023, à partir des données d'aires de distribution (n = 225) pour les espèces retrouuvées dans le Nord."
#| warning: false
#| 
# conversion from species characters to ordered levels of factor for keeping increasing SPI
...
#| fig-cap: "Valeur de l'indicateur de protection des espèces en 2023, à partir des données d'aires de distribution (n = 225) pour les espèces retrouuvées dans le Sud."
#| warning: false
#| 
# conversion from species characters to ordered levels of factor for keeping increasing SPI
...
#| fig-cap: "Valeur de l'indicateur de protection des espèces en 2023, à partir des données d'aires de distribution (n = 225) pour les espèces retrouuvées dans le Nord et le Sud."
#| warning: false
