...
L'habitat protégé est calculé par espèce et par année en faisant l'intersection entre les occurrences et les aires protégées.
...
Les résultats par espèce sont enregistrés dans le fichier `results/SPI.csv` du [répertoire GitHub](https://github.com/ReseauBiodiversiteQuebec/SPI/blob/section_ranges).
