...
- La portion nordique de la distribution des espèces est mieux protégée que la portion du sud
...
- Les espèces du nord sont mieux protégées que celles du sud : 
  - `r round(mean(SPI_RANGES_2023$SPI_NORTH, na.rm = T), digit = 2)`% (sd = `r round(sd(SPI_RANGES_2023$SPI_NORTH, na.rm = T), digit = 2)`%) de la superfice > 49e parallèle vs. `r round(mean(SPI_RANGES_2023$SPI_SOUTH, na.rm = T), digit = 2)`% (sd = `r round(sd(SPI_RANGES_2023$SPI_SOUTH, na.rm = T), digit = 2)`%) sous le 49e parallèle de la superficie des aires de distribution est protégée
  - `r round(mean(SPI_OCC_2023$SPI_NORTH, na.rm = T), digit = 2)`% (sd = `r round(sd(SPI_OCC_2023$SPI_NORTH, na.rm = T), digit = 2)`%) de la superfice > 49e parallèle vs. `r round(mean(SPI_OCC_2023$SPI_SOUTH, na.rm = T), digit = 2)`% (sd = `r round(sd(SPI_OCC_2023$SPI_SOUTH, na.rm = T), digit = 2)`%) sous le 49e parallèle de la superficie des occurrences est protégée
